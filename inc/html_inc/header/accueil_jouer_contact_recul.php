...
?>
			...
			<div class="w3-bar" id="myNavbar">
				...
				<a href="/game/#game" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-th"></i>  JOUER</a>
			...
			<div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
				<a href="/game/#game" class="w3-bar-item w3-button" onclick="toggleFunction()">JOUER</a>
